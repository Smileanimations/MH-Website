...
<nav class="navbar navbar-expand-lg border-bottom border-2 border-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="Images/navbarlogo.png" alt="" style="width: 80%;"></a>
...
<?php foreach ($monsters as $index => $monster) {?>
    <div>
        ...
        <div class="clearfix">
            <img class="float-end float-top" src="Images/monsters/<?php echo str_replace(" ","_", $monster['name'])?>.webp" alt="Responsive image" id="image">
                    ...
                    <?php 
                        ...
                        foreach ($relatedmonsters as $relatedmonster) { ?>      
                            <div class="text-center col-4 ">
                                <a href="details.php?name=<?= $relatedmonster?>"><img src="Images/icons/<?php echo str_replace(" ","_",$relatedmonster)?>.webp" alt="" class="icons"></a>
                            ...
                            foreach($locales as $index => $locale) {
                                ...
                                if (in_array($monster['name'], $local)) { ?>
                                    <div class="col text-center mb-3">
                                        ...
                                        <a href="localedetails.php?id=<?=$locale['id']?>"><img src="Images/locales/<?php echo str_replace(" ","_",$locale['name'])?>.webp" alt="" style="width: 400px; height: 258px;" class="locales"></a>     
                                    </div>               
                        <?php }} ?>
                    </div>            
                </div>
