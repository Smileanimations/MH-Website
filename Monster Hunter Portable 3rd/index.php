...
<body>
    <div class="row">
        <div class="col text-center">
            <img src="Images/logo.png" alt="" style="width: 35%;" class="p-4">
        </div>
    </div>
    <div class="row">
        <div class="col text-center">
            <img src="Images/monsters/Zinogre.webp" alt="" style="width: 82%;">
        </div>
        <div class="col"> 
            <video src="Images/video/intro.mp4" autoplay muted class="rounded-4" ></video>
        </div>
        <div class="col text-center">
            <img src="Images/monsters/Amatsu.webp" alt="" style="width: 400px;" class="mr-3">
        </div>
    </div>
    <div class="border-top border-bottom border-4 border-dark row text-center mt-5">
        <div class="col py-3">
            <a href="monsters.php"><img src="Images/icons/Amatsu.webp" alt="" class="icons"></a>
            <h4>Monsters</h4>
        </div>
        <div class="col-2 py-3">
            <a href="weapons.php"><img src="Images/weapon_icons/Great_Sword.png" alt="" class="icons"></a>
            <h4>Weapons</h4>
        </div>
        <div class="col py-3">
            <a href="locales.php"><img src="Images/locale_icons/FieldIcon09.png" alt="" class="icons"></a>
            <h4>Locales</h4>
        </div>
    </div>
    <div>
        <img src="Images/Yukumo-Village.webp" alt="" class="float-start p-4" style="width:30%;">
