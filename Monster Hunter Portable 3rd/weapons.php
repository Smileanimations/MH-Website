...
<nav class="navbar navbar-expand-lg border-bottom border-2 border-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="Images/navbarlogo.png" alt="" width="106" height="70"></a>
        ...
        <div class="row">
          <?php foreach ($weapons as $index => $weapon) {
              ...
              <div class="col mx-5 mt-4">
                  <form method="post">
                  <button name="<?= $id = $weapon['id']?>" value="<?= $weapon['id']?>" type="submit"><img src="Images/weapon_icons/<?= str_replace(" ", "_", $weapon['name'])?>.png" alt="" class="icons"></button>
                  <p><?= $weapon['name']?></p>
                  </form>
              </div>   
          <?php }}?>
...
<div class="mx-5 mt-5 mb-3 p-3 text-center border rounded-5" id="weaponinfo">
  <div>
    ...
    <div>
        ...
        <img src="Images/weapons/<?= str_replace(" ", "_", $subweapon['name'])?>.webp" alt="" class="renders">
        <div class="mx-5 px-5">
